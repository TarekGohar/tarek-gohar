...
export default function SecuritySection() {
  return (
    <section className="relative min-h-[43rem] md:min-h-[50rem] max-w-[120rem] mx-auto w-full h-full flex flex-col items-center justify-center overflow-hidden space-y-[2rem] px-4 md:px-8">
