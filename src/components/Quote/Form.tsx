...
const BACKGROUND =
  "linear-gradient(rgba(255, 255, 255, 0.1),  rgba(8, 145, 178, 0.03) 100%)";
const BACKGROUND_ERROR =
  "linear-gradient(rgba(255, 255, 255, 0.1),  rgba(239, 68, 68, 0.03) 100%)";
    ...
    >
      ...
      <div className={`w-full`} style={{ marginBottom: FORM_TITLE_SPACING }}>
        ...
        <input
          ...
          className="pl-2 h-[3rem] rounded-none w-full text-cyan-800 placeholder:text-neutral-200"
          style={{
            background: formState.errors.email ? BACKGROUND_ERROR : BACKGROUND,
            transitionDuration: "0.3s",
