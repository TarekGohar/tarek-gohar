  ...
  return (
    <section className="mt-[2.5rem] h-[17.5rem] md:mt-[10rem] md:h-[25rem] flex items-start justify-center">
      <div className=" max-w-[120rem] mx-auto flex flex-col items-center justify-center space-y-1 px-4">
        <h1 className="text-xl font-semibold text-neutral-400 opacity-70 capitalize">
        ...
        <Link
          ref={ref}
          className=" max-w-[20rem] md:max-w-[32rem] text-cyan-700/60 text-center font-semibold text-3xl tracking-tighter header-underline capitalize"
          href="/contact"
        >
          <motion.h3
