      ...
      <div className="py-[10rem] md:py-[20rem] relative max-w-[120rem] mx-auto w-full  flex flex-col items-center justify-center px-4 md:px-8">
        ...
        <div className="max-w-[100rem] w-full flex flex-col items-start justify-center space-y-[5rem] md:space-y-[10rem]">
          <div className="w-full flex flex-col lg:flex-row items-start justify-between space-y-[2rem] lg:space-y-0 lg:space-x-[5rem]">
            <h2 className="w-full mx-auto lg:mx-0 lg:max-w-[45rem] text-cyan-800 text-left font-medium text-4xl md:text-7xl uppercase tracking-wider">
          ...
          <div className="mx-auto w-fit grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-x-[5rem] lg:gap-16 text-cyan-800/80">
            <div className="md:w-fit flex flex-col gap-y-4 items-center justify-center ">
              <ScoreCircle />
              <h1 className="text-lg md:text-2xl font-semibold">SEO</h1>
            </div>
            <div className="md:w-fit flex flex-col gap-y-4 items-center justify-center">
              <ScoreCircle delay={0.05} />
              <h1 className="text-lg md:text-2xl font-semibold">Performance</h1>
            </div>
            <div className="md:w-fit flex flex-col gap-y-4 items-center justify-center">
